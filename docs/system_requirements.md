# FileMRI 다른 컴퓨터 설치 요구사항 체크리스트

## 🎯 FileMRI_Optimized.exe 실행 요구사항
...
#### 1. **Microsoft Visual C++ Redistributable**
   ...
   - **확인 방법**: FileMRI 실행 시 "VCRUNTIME140.dll 없음" 오류 발생시 필요
...
#### **단계 1: 단순 실행 테스트**
1. FileMRI_Optimized.exe를 다른 컴퓨터에 복사
2. 더블클릭하여 실행
3. GUI 창이 뜨는지 확인
...
**해결**: Windows Defender 제외 목록에 FileMRI 추가
...
---
**테스트 일자**: 2025-08-26
**빌드 버전**: FileMRI_Optimized.exe (53MB)
